...
## 🧑‍💻 프로젝트 배경
단체 여행에서 총무가 모든 결제를 맡거나, 여러 사람이 결제 후 뒤섞인 내역을 정리하는 과정은 종종 부담스럽고 비효율적입니다. 특히, 해외 여행에서는 환율 기준이 모호해 정산 과정에서 혼란이 가중되기도 합니다. 이러한 문제를 해결하기 위해, 누구나 간편하게 결제 내역을 기록하고 실시간으로 정산할 수 있는 자동화된 시스템을 기획했습니다.
<br/>
