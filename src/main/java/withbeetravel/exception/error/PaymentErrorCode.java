...
public class PaymentErrorCode extends ErrorCode{
    ...
    public static final PaymentErrorCode INVALID_SORT_TYPE = new PaymentErrorCode(HttpStatus.BAD_REQUEST, "INVALID_SORT_TYPE", "PAYMENT-005", "정렬 기준은 latest 또는 amount만 가능");
