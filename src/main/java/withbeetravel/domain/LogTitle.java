...
public enum LogTitle {
    PAYMENT_REQUEST("결제 내역 정리 요청", "{0}의 여행이 끝났어요! 🚗💨 함께 사용한 비용들을 정리해 볼까요? 공동 결제 내역을 확인하고 마무리해 주세요."),
    ...
    SETTLEMENT_RE_REQUEST("정산 재요청", "{0}의 정산 요청에 아직 동의하지 않았어요! 😅 혹시 잊으신 건 아닌가요? 빠르게 정산을 완료해 주세요."),
    SETTLEMENT_COMPLETE("정산 완료", "{0}의 정산이 완료되었습니다! 🎉 위비가 {1}원을 지원했습니다.🍀 위비와 함께하는 다음 여행도 기대해요!");
